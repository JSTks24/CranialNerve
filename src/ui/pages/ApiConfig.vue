      ...
      <div class="cn-card api-preset-card">
        ...
        <div class="cn-card__body">
          <div v-if="presets.length === 0 && !drafting" class="cn-empty">
            暂无 API 预设，请新建
            <button class="cn-btn cn-btn--sm" style="margin-left: 8px" @click="createPreset">
          ...
          <template v-else>
            <div class="cn-field">
              ...
              <div class="api-preset-select-row">
                <select
                  class="cn-select"
                  style="flex: 1"
                  :value="drafting ? '__draft__' : selectedId"
                ...
                <button class="cn-btn cn-btn--sm" @click="createPreset">
            ...
            <div class="cn-field">
              ...
              <select class="cn-select" v-model.number="editing.maxTokens">
                <option
                  v-for="v in [1024, 2048, 4096, 8192, 16384, 32768, 65536]"
                  :key="v"
                  :value="v"
                >
                  {{ v }}
